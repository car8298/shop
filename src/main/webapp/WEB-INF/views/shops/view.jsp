...
<style>
	...
	div.goods div.goodsInfo p span { display:inline-block; width:100px; margin_right:15px; }
	
	div.goods div.goodsInfo p.cartStock input { font-size:22px; width:50px; padding:5px; margin:0px; border:1px solid #eee;}
...
<style>
	...
	section.replyFrom button { font-size:20px; padding:5px 10px; margin:10px 0; background:#fff; border:1px solid #ccc; }
...
function replyList() {
	...
	$.getJSON("/shops/view/replyList" + "?n=" + gdsNum, function(data){
		var str = "";
			...
			<section id="content">
				...
				<div class="goods">
					...
					<div class="goodsInfo">
						...
						<p class="gdsPrice"><span>가격</span>
							<fmt:formatNumber pattern="###,###,###" value="${view.gdsPrice}" /> 원
						</p>
						<p class="gdsStock"><span>재고</span>
