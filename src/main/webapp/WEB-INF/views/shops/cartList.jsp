...
/*	section#content ul li { display:inline-block; margin:10px; }
	...
	section#content div.thumb { float:left; width:250px; height:auto; }
	section#content div.gdsInfo { float:right; width:calc(100% - 330px); }
	...
	section#content div.gdsInfo .delete button { font-size:22px; padding:5px 10px;
			...
			<section id="content">
				<ul>
					...
					<li>
						...
						<div class="gdsInfo">
							<p>
								<span>상  품  명 : </span>${cartList.gdsName}<br />
								<span>개당 가격 : </span>
